...
Sidebar.prototype.addGeneralPalette = function(expand)
{
	...
	this.addPaletteFunctions('general2', mxResources.get('general2'), (expand != null) ? expand : true, fns2);
	this.setCurrentSearchEntryLibrary();

	this.addPaletteFunctions('general3', mxResources.get('general3'), (expand != null) ? expand : true, fns3);
	this.setCurrentSearchEntryLibrary();
	this.addPaletteFunctions('general4', mxResources.get('general4'), (expand != null) ? expand : true, fns4);
	this.setCurrentSearchEntryLibrary();
};
